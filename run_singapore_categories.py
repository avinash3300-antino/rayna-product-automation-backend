"""Run the REAL pipeline for ALL 15 Singapore categories sequentially.

Usage: python run_singapore_categories.py
"""
import asyncio
import logging
import traceback
...
logger = logging.getLogger("singapore_categories")
